...
public partial class WebApplicantPolicyInfo
{
    public int WebApplicantPolicyId { get; set; }

    public string? WedApplicantDocId { get; set; }
    ...
    public string? OtherPolicyAccpDate { get; set; }
