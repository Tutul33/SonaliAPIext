...
public partial class PolicyApplicantsPersonalInfo
{
    ...
    public string? SummeryCommentBy { get; set; }

    public DateTime? SummeryCommentDate { get; set; }
    ...
    public virtual ICollection<PolicyApplicantsFamilyHistory> PolicyApplicantsFamilyHistories { get; set; } = new List<PolicyApplicantsFamilyHistory>();
    ...
    public virtual ICollection<PolicyDoctorSecretInfo> PolicyDoctorSecretInfos { get; set; } = new List<PolicyDoctorSecretInfo>();

    public virtual ICollection<PolicyMedicalExamReport> PolicyMedicalExamReports { get; set; } = new List<PolicyMedicalExamReport>();

    public virtual ICollection<PolicyProvisionalReceipt> PolicyProvisionalReceipts { get; set; } = new List<PolicyProvisionalReceipt>();

    public virtual ICollection<TmpPolicyApplicantNominee> TmpPolicyApplicantNominees { get; set; } = new List<TmpPolicyApplicantNominee>();

    public virtual ICollection<TmpPolicyApplicantsFamilyHistory> TmpPolicyApplicantsFamilyHistories { get; set; } = new List<TmpPolicyApplicantsFamilyHistory>();
